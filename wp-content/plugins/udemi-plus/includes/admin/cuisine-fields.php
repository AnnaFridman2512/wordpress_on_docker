...
function up_cuisine_add_form_fields() {
    ...
    <div class="form-field">
        ...
        <p><?php _e('A URL a user can click to learn more info about this cuisine')?></p>
    </div>
...
<tr class="form-field">
    ...
    <input type="text" name="up_more_info_url"
        value="<?php echo $url; ?>" />
        <p class="description"><?php _e('A URL a user can click to learn more info about this cuisine')?></p>
    </td>
    </th>
